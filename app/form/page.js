    ...
    <div>
      ...
      <div className=" bg-slate-100 flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 gap-1">
        ...
        <form className="space-y-2 md:space-y-2 bg-slate-100">
          ...
          <input name="file" placeholder="upload Profile Image" type="file" onChange={(e)=>setFile(e.target.files[0])} className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"/>
          </div>
          <button
